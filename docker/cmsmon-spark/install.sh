...
pip install --no-cache-dir click matplotlib numpy opensearch-py~=2.1 opentelemetry-exporter-otlp~=1.39.0 pandas plotly pyspark requests==2.29 schema seaborn stomp.py==7.0.0
